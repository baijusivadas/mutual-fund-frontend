    ...
    return (
        <DashboardLayout>
            <div className="space-y-6">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight">Other Assets</h2>
                    <p className="text-muted-foreground">Manage your Bank Accounts, FDs, PPF, EPF, and Custom Assets.</p>
                </div>
