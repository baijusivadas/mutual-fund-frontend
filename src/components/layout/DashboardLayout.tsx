import { createContext, useContext, ReactNode, memo, useState } from "react";
...
const DashboardLayoutComponent = ({ children }: DashboardLayoutProps) => {
  ...
  // If already rendered inside an existing DashboardLayout context, return children or Outlet directly
  // so nested page-level DashboardLayout wrappers don't duplicate the sidebar and header.
  if (isInsideLayout) {
  ...
  return (
    <DashboardLayoutContext.Provider value={true}>
      <div className="flex h-screen w-full overflow-hidden bg-background">
        {/* Desktop Sidebar (permanently mounted) */}
